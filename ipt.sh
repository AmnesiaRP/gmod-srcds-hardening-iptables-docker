...
iptables -I PREROUTING 1 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
...
iptables -I PREROUTING 2 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m string --algo bm --hex-string |$PKT_A2S| \
...
iptables -I PREROUTING 3 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m string --algo bm --hex-string |$PKT_A2S| \
	-j DROP
...
iptables -I PREROUTING 4 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
...
iptables -I PREROUTING 5 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m string --algo bm --hex-string |$PKT_LOG| \
	-m length --length 48 --from 26 --to 48 \
...
iptables -I PREROUTING 7 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
...
iptables -I PREROUTING 8 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m length --length 0:32 \
	-j DROP
...
iptables -I PREROUTING 9 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
...
iptables -I PREROUTING 10 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m length --length 2521:65535 \
	-j DROP
...
iptables -I PREROUTING 11 $CMD_BASE \
	$CMD_COMMENT \
...
iptables -I PREROUTING 12 $CMD_BASE \
	$CMD_COMMENT \
	-m set --match-set permatrusted src \
	-j ACCEPT
...
iptables -I PREROUTING 13 $CMD_BASE \
	$CMD_COMMENT \
...
iptables -I PREROUTING 14 $CMD_BASE \
	$CMD_COMMENT \
	-m set --match-set signed_on src,dst \
	-j ACCEPT
...
iptables -I PREROUTING 15 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m hashlimit \
...
iptables -I PREROUTING 16 $CMD_BASE \
	$CMD_COMMENT \
	$CMD_PORTS \
	-m hashlimit \
		--hashlimit-name speedlimit \
